...
if(row==-1){
    JOptionPane.showMessageDialog(this, "Please select employee to remove", "error", JOptionPane.ERROR_MESSAGE);
}
else{
    int user_id = Integer.parseInt(jTable1.getValueAt(row, 0).toString());
    sql.deleteEmployee(user_id);
